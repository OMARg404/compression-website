...
const Pro = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (file) {
            ...
            formData.append('text', text); // Append the text if no file
        }
        ...
        try {
            ...
            setError('An error occurred during compression: ' + (error.response?.data?.error || error.message));
        } finally {
            setLoading(false);
            setTimeout(() => {
                setRotating(false);
    ...
    return (
        <div className="container mt-4">
            <h1 className="text-center text-primary">Text Compression</h1>
